...
import com.spring.Constant.Names;
...
//                                System.out.println(beanName);
                            ...
                            /**
                             * get all the interfaces in a component
                             */
                            Class<?>[] interfaces = clazz.getInterfaces();
                            for (Class<?> Interface : interfaces) {
//                                System.out.println("!!!!!interfaces in " + Interface);
                                /**
                                 * if clazz has the interface DisposableBean
                                 */
                                if (("com.spring." + Names.DisposableBean).equals(Interface.getName())) {
                                    try {
                                        Method destroy = clazz.getDeclaredMethod("destroy", null);
                                        beanDefinition.setDisposable(destroy);
                                    } catch (NoSuchMethodException e) {
...
//            }
    ...
    public void destroyBean (BeanDefinition beanDefinition, Object object) {
        /**
         * invoke the methods in PreDestroy interface
         */
...
//                System.out.println(method.getDeclaringClass().getName());
        ...
        /**
         * invoke the method with DisposableBean interface
         */
        Method disposable = beanDefinition.getDisposable();
        try {
            if (disposable != null) {
                disposable.invoke(sourceTarget);
            }
        } catch (IllegalAccessException e) {
            throw new RuntimeException(e);
        } catch (InvocationTargetException e) {
